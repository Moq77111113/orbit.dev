...
{:else}
  ...
  >
    ...
    <div
      class={cn(
        'relative h-[calc(75%)] w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear',
    ...
    <div
      class={cn(
        'fixed top-16 h-[calc(75%)] z-10 hidden  w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex',
        side === 'left'
